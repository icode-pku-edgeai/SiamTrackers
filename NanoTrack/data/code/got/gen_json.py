...
got10k = json.load(open('C:\\Users\\li\\Desktop\\repo\\track\\SiamTrackers-master\\NanoTrack\\data\\origin_dataset\\10homemade_video\\homemade.json', 'r'))
...
json.dump(train, open('C:\\Users\\li\\Desktop\\repo\\track\\SiamTrackers-master\\NanoTrack\\data\\origin_dataset\\10homemade_video\\crop511\\train.json', 'w'), indent=4, sort_keys=True)
# json.dump(val, open('/data2/got10k/val.json', 'w'), indent=4, sort_keys=True)
# json.dump(val, open('C:\\Users\\li\\Desktop\\repo\\SiamTrackers-master\\NanoTrack\\data\\results\\homemade\\crop255\\val.json', 'w'), indent=4, sort_keys=True)
print('done!')
