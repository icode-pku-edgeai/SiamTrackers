...
parser.add_argument('--dir',type=str, default='C:\\Users\\li\\Desktop\\repo\\track\\SiamTrackers-master\\NanoTrack\\data\\origin_dataset\\10homemade_video', help='your vid data dir')
...
for sub_set in sub_sets:
    ...
    for vi, video in enumerate(videos):
        ...
        # get image size
        im_path = join(video_base_path, '00000000.jpg')
...
json.dump(got10k, open('C:\\Users\\li\\Desktop\\repo\\track\\SiamTrackers-master\\NanoTrack\\data\\origin_dataset\\10homemade_video\\homemade.json', 'w'), indent=4, sort_keys=True)
