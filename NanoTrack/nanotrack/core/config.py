...
# Number of anchors per images 采样总点数
...
__C.TRAIN.LR_WARMUP.TYPE = 'step'#递进学习率衰减，warmup

__C.TRAIN.LR_WARMUP.EPOCH = 5#warmup代数
...
__C.DATASET.COCO = CN()
__C.DATASET.COCO.ROOT = '/datasets/datasets/new_dataset/nanotrack_dataset/coco_tank_20240901/crop511'
__C.DATASET.COCO.ANNO = '/datasets/datasets/new_dataset/nanotrack_dataset/coco_tank_20240901/crop511/train.json'
...
# Window influence窗口因子
__C.TRACK.WINDOW_INFLUENCE = 0.46

# Interpolation learning rate学习率,前帧学后帧的学习率
__C.TRACK.LR = 0.34
